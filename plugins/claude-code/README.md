...
| Commands | `commands/inbox.md`, `commands/ask.md`, `commands/history.md`, `commands/me.md`, `commands/update.md` | `/owlpost:inbox`, `/owlpost:ask <peer> <path> <question>`, `/owlpost:history`, `/owlpost:me`, `/owlpost:update`. |
