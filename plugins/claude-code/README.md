...
| Commands | `commands/inbox.md`, `commands/ask.md`, `commands/contacts.md`, `commands/history.md`, `commands/me.md`, `commands/update.md`, `commands/add.md` | `/owlpost:inbox`, `/owlpost:ask <peer> [path] <question>`, `/owlpost:contacts` (pick a peer with the arrow keys, then ask or show the card), `/owlpost:history`, `/owlpost:me`, `/owlpost:update`, `/owlpost:add <peer json|file> [--local]`. |
